...
export const addToCartSuccess = createAction<any>("cart/addToCartSuccess");
...
export const fetchCartSuccess = createAction<any[]>("cart/fetchCartSuccess");
...
export const updateCartItemQuantitySuccess = createAction<any>("cart/updateCartItemQuantitySuccess");
...
export const deleteCartItemSuccess = createAction<any>("cart/deleteCartItemSuccess");
...
const slice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(addToCartSuccess, (state, action: PayloadAction<any>) => {
        state.loading = false;
    ...
    builder
      ...
      .addCase(fetchCartSuccess, (state, action: PayloadAction<any[]>) => {
        state.loading = false;
